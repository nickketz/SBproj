classdef kmlAnimation < handle
   ...
   methods
       ...
       function updateLocation(this,target,waitingTime,longitude,latitude,altitude)
           ...
           animUpdate.appendChild(kml.textNode('gx:duration',num2str(waitingTime)));
           
           location.setAttribute('targetId',target.location_id);
           location.appendChild(kml.textNode('latitude',  num2str(latitude)));
           location.appendChild(kml.textNode('longitude', num2str(longitude)));
           location.appendChild(kml.textNode('altitude',  num2str(altitude)));
       ...
       function updateOrientation(this,target,waitingTime,heading,tilt,roll)
           ...
           orientation.appendChild(kml.textNode('heading', num2str(heading)));
           orientation.appendChild(kml.textNode('tilt',    num2str(tilt)));
           orientation.appendChild(kml.textNode('roll',    num2str(roll)));
       ...
       function updateScale(this,target,waitingTime,scaleX,scaleY,scaleZ)
           ...
           scale.appendChild(kml.textNode('x', num2str(scaleX)));
           scale.appendChild(kml.textNode('y', num2str(scaleY)));
           scale.appendChild(kml.textNode('z', num2str(scaleZ)));
...
%            animUpdate.appendChild(kml.textNode('gx:duration',num2str(waitingTime)));
           ...
           item.setAttribute('targetId',target.id);
           item.appendChild(kml.textNode('name', num2str(text)));
       ...
       function flyToCamera(this,waitingTime,longitude,latitude,altitude,heading,tilt,roll,altitudeMode)
           ...
           flyTo.appendChild(kml.textNode('gx:duration',num2str(waitingTime)));
           flyTo.appendChild(kml.textNode('gx:flyToMode','smooth'));
           camera = kml.xml.createElement('Camera');
           camera.appendChild(kml.textNode('longitude',num2str(longitude)));
           camera.appendChild(kml.textNode('latitude',num2str(latitude)));
           camera.appendChild(kml.textNode('altitude',num2str(altitude)));
           h = heading-180;
           ...
           camera.appendChild(kml.textNode('heading',num2str(heading)));
           camera.appendChild(kml.textNode('tilt',num2str(tilt)));
           camera.appendChild(kml.textNode('roll',num2str(roll)));
       ...
       function flyToLookAt(this,waitingTime, longitude,latitude,altitude,altitudeMode, heading, tilt)
          ...
          if nargin < 8
           ...
           lookAt.appendChild(kml.textNode('longitude',num2str(longitude)));
           lookAt.appendChild(kml.textNode('latitude',num2str(latitude)));
           lookAt.appendChild(kml.textNode('altitude',num2str(altitude)));
           lookAt.appendChild(kml.textNode('altitudeMode',altitudeMode));
           lookAt.appendChild(kml.textNode('heading',num2str(heading)));
           lookAt.appendChild(kml.textNode('tilt',num2str(tilt)));
       ...
       function wait(this,waitingTime)
           ...
           wait.appendChild(this.kml.textNode('gx:duration',num2str(waitingTime)));

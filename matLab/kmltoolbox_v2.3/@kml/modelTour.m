...
%   $Revision: 2.3 $  $Date: 2012/09/05 08:00:00 $
    ...
    location.appendChild(this.textNode('latitude',  num2str(lat(1))));
    location.appendChild(this.textNode('longitude', num2str(long(1))));
    location.appendChild(this.textNode('altitude',  num2str(alt(1))));
    ...
    for i = 2:nlat-1
        ...
        location.appendChild(this.textNode('latitude',  num2str(lat(i))));
        location.appendChild(this.textNode('longitude', num2str(long(i))));
        location.appendChild(this.textNode('altitude',  num2str(alt(i))));
        ...
        switch arg.cameraMode
            ...
            case 'behind'
                ...
                camera.appendChild(this.textNode('longitude',num2str(long(i)-dS(1))));
                camera.appendChild(this.textNode('latitude',num2str(lat(i)-dS(2))));
                camera.appendChild(this.textNode('altitude',num2str(alt(i))));
                h = heading(i)-180;
            ...
            case 'above'
                ...
                lookAt.appendChild(this.textNode('longitude',num2str(long(i))));
                lookAt.appendChild(this.textNode('latitude',num2str(lat(i))));
                lookAt.appendChild(this.textNode('altitude',num2str(alt(i) + arg.cameraDistance)));

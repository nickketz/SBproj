...
%   $Revision: 2.3 $  $Date: 2012/09/05 08:00:00 $
    ...
    llbox.appendChild(this.textNode('north',    num2str(north)));
    llbox.appendChild(this.textNode('south',    num2str(south)));
    llbox.appendChild(this.textNode('east',     num2str(east)));
    llbox.appendChild(this.textNode('west',     num2str(west)));

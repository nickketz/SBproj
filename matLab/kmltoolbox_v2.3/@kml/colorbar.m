...
% </ScreenOverlay>
    ...
    overlayXY.setAttribute('x',num2str(overlayPos(1)))
    overlayXY.setAttribute('y',num2str(overlayPos(2)))
    overlayXY.setAttribute('xunits','fraction')
    overlayXY.setAttribute('yunits','fraction')
    
    screenXY.setAttribute('x',num2str(screenPos(1)))
    screenXY.setAttribute('y',num2str(screenPos(2)))
    screenXY.setAttribute('xunits','fraction')
    screenXY.setAttribute('yunits','fraction')    
    
    size.setAttribute('x',num2str(sz(1)))
    size.setAttribute('y',num2str(sz(2)))
